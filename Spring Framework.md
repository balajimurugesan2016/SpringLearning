...
```
**Annotation configuration application context forms an umbrella on top of the bean factory and converts the application as an enterprise applicat**
## Delete a file
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MDUxMTUyNzksMTE0NDczNjM4Nyw4Mj
UzNzEzODNdfQ==
-->